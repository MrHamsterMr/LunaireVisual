...
public class ModuleManager {
    ...
    public static void init() {
        ...
        modules.add(new LunaireModule("InfoHUD", Category.HUD, 0) {
            @Override
            public void onRenderHud(DrawContext context) {
        ...
        // Оставшиеся заглушки
        String[] rest = {"ItemScroller", "Optimization", "ChunkOpt", "BlockOverlay", "Crosshair", "ShulkerView", "ItemGlow"};
        for (String s : rest) {
            modules.add(new LunaireModule(s, Category.MISC, 0) {});
        }
    }
