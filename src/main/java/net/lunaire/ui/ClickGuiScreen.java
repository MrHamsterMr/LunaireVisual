                ...
                if (m.getCategory() == cat) {
                    ...
                    if (m.showSettings) {
                        ...
                        for (Setting s : m.settings) {
                            context.drawText(textRenderer, s.name + (s.type.equals("num") ? ": " + (int)s.dVal : ""), x + 120, sy + 5, s.bVal ? 0xFF00FBFF : -1, false);
                            sy += 15;
                        }
                    }
                    y += 16;
        ...
        for (Category cat : Category.values()) {
            ...
            for (LunaireModule m : ModuleManager.getModules()) {
                if (m.getCategory() == cat) {
                    ...
                    if (mouseX >= x + 92 && mouseX <= x + 110 && mouseY >= y && mouseY <= y + 14) { m.showSettings = !m.showSettings; return true; }
